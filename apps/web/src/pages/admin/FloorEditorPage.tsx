  ...
  return (
    <section className="stack">
      <div className="row">
        ...
        <h1 className="grow">{floor.name}</h1>
        {savedFlash ? (
      ...
      {!floor.plan ? (
        ...
        >
          ...
          <aside className="card stack" style={{ minHeight: 180 }}>
            <h2>{t("editFeature")}</h2>
            {!selected ? (
              <p className="muted">{t("selectFeatureHint")}</p>
            ) : (
              <>
                ...
                <div className="label">
                  ...
                  <div className="row">
                    <button type="button" onClick={() => void nudgeLayer("bottom")} className="tool-btn">
                      {t("sendToBack")}
                    </button>
                    <button type="button" onClick={() => void nudgeLayer("back")} className="tool-btn">
                      {t("sendBackward")}
                    </button>
                    <button type="button" onClick={() => void nudgeLayer("forward")} className="tool-btn">
                      {t("bringForward")}
                    </button>
                    <button type="button" onClick={() => void nudgeLayer("front")} className="tool-btn">
                      {t("bringToFront")}
                    </button>
                  </div>
                </div>
                ...
                <button type="button" onClick={() => void onDeleteSelected()} className="btn btn-sm btn-danger">
                  {t("delete")}
                </button>
              </>
            )}
